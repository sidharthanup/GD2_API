...
class DefaultApi(object):
    ...
    def self_heal_info(self, volname, **kwargs):  # noqa: E501
        """self_heal_info  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.self_heal_info(volname, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.self_heal_info_with_http_info(volname, **kwargs)  # noqa: E501
        else:
            (data) = self.self_heal_info_with_http_info(volname, **kwargs)  # noqa: E501
            return data

    def self_heal_info_with_http_info(self, volname, **kwargs):  # noqa: E501
        """self_heal_info  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.self_heal_info_with_http_info(volname, async_req=True)
        >>> result = thread.get()
