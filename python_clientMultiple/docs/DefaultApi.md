...
------------- | ------------- | ------------- | -------------
 **volume** | [**Volume**](Volume.md)| Volume Create | 
...
try:
    api_response = api_instance.edit_peer(peerid, volume)
    pprint(api_response)
except ApiException as e:
...
try:
    api_response = api_instance.volume_create(volume)
    pprint(api_response)
except ApiException as e:
