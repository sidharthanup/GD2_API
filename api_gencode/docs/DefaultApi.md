...
try:
    api_response = api_instance.edit_peer(peerid, add=add)
    pprint(api_response)
except ApiException as e:
...
try:
    api_response = api_instance.volume_create(add=add)
    pprint(api_response)
except ApiException as e:
