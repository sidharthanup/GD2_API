...
# **add_peer**
> Peer add_peer(unknown_base_type=unknown_base_type)
...
# **edit_peer**
> Peer edit_peer(peerid, unknown_base_type=unknown_base_type)
...
try:
    api_response = api_instance.edit_peer(peerid, unknown_base_type=unknown_base_type)
    pprint(api_response)
except ApiException as e:
...
# **volume_create**
> Volume volume_create(unknown_base_type=unknown_base_type)
...
try:
    api_response = api_instance.volume_create(unknown_base_type=unknown_base_type)
    pprint(api_response)
except ApiException as e:
