...
class DefaultApi(object):
    ...
    def geo_replication_config_set_with_http_info(self, mastervolid, remotevolid, **kwargs):  # noqa: E501
        ...
        all_params = ['mastervolid', 'remotevolid', 'option2']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        body_params = None
        if 'option2' in local_var_params:
            body_params = local_var_params['option2']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def geo_replication_pause_with_http_info(self, mastervolid, remotevolid, **kwargs):  # noqa: E501
        ...
        all_params = ['mastervolid', 'remotevolid', 'start_stop']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        body_params = None
        if 'start_stop' in local_var_params:
            body_params = local_var_params['start_stop']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
