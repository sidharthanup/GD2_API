...
> OptionResp geo_replication_config_get(mastervolid, remotevolid)
...
> OptionResp geo_replication_config_set(mastervolid, remotevolid, option=option)
...
mastervolid = 'mastervolid_example' # str | 
remotevolid = 'remotevolid_example' # str | 
option = openapi_client.Option() # Option |  (optional)

try:
    api_response = api_instance.geo_replication_config_set(mastervolid, remotevolid, option=option)
    pprint(api_response)
except ApiException as e:
...
> Session geo_replication_pause(mastervolid, remotevolid, pause=pause)
...
mastervolid = 'mastervolid_example' # str | 
remotevolid = 'remotevolid_example' # str | 
pause = openapi_client.Pause() # Pause |  (optional)

try:
    api_response = api_instance.geo_replication_pause(mastervolid, remotevolid, pause=pause)
    pprint(api_response)
except ApiException as e:
...
> Session geo_replication_resume(mastervolid, remotevolid, resume=resume)
...
mastervolid = 'mastervolid_example' # str | 
remotevolid = 'remotevolid_example' # str | 
resume = openapi_client.Resume() # Resume |  (optional)

try:
    api_response = api_instance.geo_replication_resume(mastervolid, remotevolid, resume=resume)
    pprint(api_response)
except ApiException as e:
...
> Session geo_replication_start(mastervolid, remotevolid, start=start)
...
mastervolid = 'mastervolid_example' # str | 
remotevolid = 'remotevolid_example' # str | 
start = openapi_client.Start() # Start |  (optional)

try:
    api_response = api_instance.geo_replication_start(mastervolid, remotevolid, start=start)
    pprint(api_response)
except ApiException as e:
...
> Session geo_replication_stop(mastervolid, remotevolid, stop=stop)
...
mastervolid = 'mastervolid_example' # str | 
remotevolid = 'remotevolid_example' # str | 
stop = openapi_client.Stop() # Stop |  (optional)

try:
    api_response = api_instance.geo_replication_stop(mastervolid, remotevolid, stop=stop)
    pprint(api_response)
except ApiException as e:
